...
function handleContourBackspace(){if(!locOK(state.selected))return;if(isCaretAtClauseStart(state.selected)){mergeClauseWithPrevious(state.selected);return;}indent(-1);}
