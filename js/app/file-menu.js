...
document.getElementById('setInclusioStart').onclick=()=>setInclusioPoint('start');
document.getElementById('setInclusioEnd').onclick=()=>setInclusioPoint('end');
document.getElementById('applyInclusioBrackets').onclick=()=>applyInclusioBrackets();
