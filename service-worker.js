const CACHE_NAME = 'contour-app-pwa-v89';
const APP_ASSETS = [
  './',
  './index.html',
  './gate.js',
  ...
  './styles/worksheet-pdf-wizard.css',
  './styles/file-menu-nav.css',
  './js/data/books.js',
  './js/data/wlc-text.js',
  './js/app/core.js',
  ...
  './js/app/file-menu.js',
  './js/app/arcs.js',
  './js/app/contour-export-overlays.js',
  './js/app/worksheet-export-config.js',
  './js/app/worksheet-pdf-wizard.js',
  './js/app/keyboard.js',
